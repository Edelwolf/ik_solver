...
// #include "opw_kinematics_impl.h"
// #include "opw_kinematics.h"
// #include "opw_parameters.h"
// #include "opw_utilities.h"

// class KinematicsService : public rclcpp::Node
// {
// public:
//     KinematicsService()
//         : Node("kinematics_service")
//     {
...
//         {
//             response->ik_result[i].valid = opw_kinematics::isValid(sols[i]);
//             response->ik_result[i].pose = opw_kinematics::forward(parameters_, sols[i]).matrix();
